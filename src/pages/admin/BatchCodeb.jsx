...
import NewBatchCodeModal from "../../components/admin/Web/Modal/NewBatchCodeModal.jsx";
import EditBatchCodeModal from "../../components/admin/Web/Modal/EditBatchCodeModal.jsx";
import EventLayoutCreate from "./EventLayout/EventLayoutCreate.jsx";
import CreateBatchCodeModal from "../../components/admin/Web/Modal/CreateBatchCodeModal.jsx"; // 배치도 컴포넌트
        ...
        <main className="p-6 flex flex-col gap-6">
            {!showLayout ? (
                ...
                <div>
                    ...
                    <EventLayoutCreate record={selectedRecordForLayout} />
                </div>
            )}
            {modalOpen && (
                <NewBatchCodeModal
