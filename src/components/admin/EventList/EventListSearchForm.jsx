...
export default function EventListSearchForm({
    ...
    const UncheckedIcon = (
        <span style={{
            ...
            border: "3px solid #C6CBDF", background: "#fff",
        }}/>
    );
    const CheckedIcon = (
        <span style={{
            display: "block", width: 24, height: 24, borderRadius: "50%",
            border: "7px solid #1F3EA6", background: "#fff",
            boxSizing: "border-box", boxShadow: "0 1px 6px 0 rgba(40,77,254,0.10)"
        }}/>
    );
    return (
